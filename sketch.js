...
var engine, world, backgroundImg, waterSound, cannonExplosion, pirataLaughSound,backgroundMusic;
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) {
        if (!isLaughing && !pirataLaughSound.isPlaying()){
          pirataLaughSound.play();
          isLaughing = true;
        }
